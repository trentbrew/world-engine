...
<Popover.Root>
  ...
  <Popover.Content side="top" align="start" class="config-panel">
    ...
    <div class="option-list">
        ...
        <span class="option-controls">
          ...
          <Switch
            ...
            onCheckedChange={(checked) =>
              viewportDebug.setValue('colliders', checked)}
          />
        </span>
      </label>
      ...
      <label class="option-row">
        ...
        <span class="option-controls">
          ...
          <Switch
            ...
            size="sm"
            onCheckedChange={(checked) =>
              viewportDebug.setValue('wireframe', checked)}
          />
        </span>
      </label>
      ...
      <label class="option-row">
        ...
        <span class="option-controls">
          ...
          <Switch
            ...
            size="sm"
            onCheckedChange={(checked) =>
              viewportDebug.setValue('shadows', checked)}
          />
        </span>
      </label>
      ...
      <label class="option-row">
        <span class="option-copy">
          <span class="option-label">Camera controls</span>
          <span class="option-hint">Follow preset + tuning panel</span>
        </span>
        <span class="option-controls">
          <Switch
            checked={viewportDebug.cameraHud}
            size="sm"
            onCheckedChange={(checked) =>
              viewportDebug.setValue('cameraHud', checked)}
          />
        </span>
      </label>
      ...
      <label class="option-row">
        <span class="option-copy">
          ...
          <span class="option-hint">Stats accordion in play bar</span>
        </span>
        <span class="option-controls">
          ...
          <Switch
            ...
            size="sm"
            onCheckedChange={(checked) =>
              viewportDebug.setValue('statsHud', checked)}
          />
        </span>
      </label>
      ...
      <label class="option-row">
        ...
        <span class="option-controls">
          ...
          <Switch
            ...
            size="sm"
            onCheckedChange={(checked) =>
              viewportDebug.setValue('jankHud', checked)}
          />
        </span>
      </label>
    </div>
